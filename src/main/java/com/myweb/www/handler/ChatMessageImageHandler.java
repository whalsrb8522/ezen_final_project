...
public class ChatMessageImageHandler {
	...
	private final String UP_DIR = "E:\\Workspace\\Spring\\_myweb\\_java\\fileUpload";
	...
	public List<ChatMessageImageVO> uploadFiles(MultipartFile[] files) {
		...
		List<ChatMessageImageVO> ListCmivo = new ArrayList<ChatMessageImageVO>();
		...
		for (MultipartFile file :  files) {
			...
			cmivo.setSave_dir(today);
			cmivo.setFile_size(file.getSize());
			cmivo.setFile_name(onlyFileName);
			cmivo.setUuid(uuid.toString());
