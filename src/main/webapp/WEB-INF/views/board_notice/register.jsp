...
<body>
	...
	<div id="container">
		...
		<form action="/board_notice/register" method="post">
		<div id="inner-box">
			<input type="hidden" name="bn_writer" value="${ses.m_nick_name }">
			<div class="loc-content"><label for="loc-content">제목</label></div>
 			<input class="border-gray" id="loc-content" name="bn_title" placeholder="제목을 입력해주세요">
		</div>		
		
		<div id="inner-box">
			<div class="loc-content"><label for="loc-content">본문</label></div>
 			<textarea class="border-gray" id="loc-content" name="bn_content" 
 			rows="20" placeholder="공지사항 내용을 입력해주세요."></textarea>
		</div>		
